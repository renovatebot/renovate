...
function addMetaData(datasource, lookupName, dep) {
  if (!dep) {
    return;
  }
  if (
    manualChangelogUrls[datasource] &&
    manualChangelogUrls[datasource][lookupName]
  ) {
    dep.changelogUrl = manualChangelogUrls[datasource][lookupName];
  }
  if (
    manualSourceUrls[datasource] &&
    manualSourceUrls[datasource][lookupName]
  ) {
    dep.sourceUrl = manualSourceUrls[datasource][lookupName];
  }
  if (
    !dep.sourceUrl &&
    dep.changelogUrl &&
