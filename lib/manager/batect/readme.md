...
If you keep your Batect configuration in other files, you'll need to tell Renovate where to find them. This includes files included into your main configuration file with `include`.
