...
const pipfile1 = fs.readFileSync(
  'lib/manager/pipenv/_fixtures/Pipfile1',
  'utf8'
);
const pipfile2 = fs.readFileSync(
  'lib/manager/pipenv/_fixtures/Pipfile2',
  'utf8'
);
const pipfile3 = fs.readFileSync(
  'lib/manager/pipenv/_fixtures/Pipfile3',
  'utf8'
);
const pipfile4 = fs.readFileSync(
  'lib/manager/pipenv/_fixtures/Pipfile4',
  'utf8'
);
const pipfile5 = fs.readFileSync(
  'lib/manager/pipenv/_fixtures/Pipfile5',
  'utf8'
);
