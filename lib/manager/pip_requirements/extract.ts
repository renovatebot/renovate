...
export function extractPackageFile(
  ...
  if (content?.includes('# This file is autogenerated by pip-compile')) {
    logger.debug(
      `pip_requirements extract ignoring ${fileName} which has been generated by pip-compile`
    );
    return null;
  }
  return extract(content, fileName, config);
}
