...
export function init(): void {
  ...
  const traceProvider = new NodeTracerProvider({
    resource: resourceFromAttributes({
      ...
      ...{
        ...awsBeanstalkDetector.detect().attributes,
        ...awsEc2Detector.detect().attributes,
        ...awsEcsDetector.detect().attributes,
        ...awsEksDetector.detect().attributes,
        ...awsLambdaDetector.detect().attributes,
      },
      ...{
        ...azureAppServiceDetector.detect().attributes,
        ...azureFunctionsDetector.detect().attributes,
        ...azureVmDetector.detect().attributes,
      },
      ...envDetector.detect().attributes,
      ...gcpDetector.detect().attributes,
      ...gitHubDetector.detect().attributes,
    }),
    spanProcessors,
  });
