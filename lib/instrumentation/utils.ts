...
// `OTEL_EXPORTER_OTLP_TRACES_PROTOCOL` takes precedence over the general
// `OTEL_EXPORTER_OTLP_PROTOCOL`.
// Defaults to `http/json`, matching Renovate's historic (pre-multi-protocol)
// behaviour, rather than the spec's `http/protobuf` default, to avoid a
// breaking change for existing users who haven't set this variable.
