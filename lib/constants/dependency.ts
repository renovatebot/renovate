...
export const DEP_TYPE_GITHUB = 'github';
export const DEP_TYPE_GIT_REPOSITORY = 'git_repository';
export const DEP_TYPE_GO_REPOSITORY = 'go_repository';
export const DEP_TYPE_GRADLE_WRAPPER = 'gradle-wrapper';
export const DEP_TYPE_HTTP_ARCHIVE = 'http_archive';
export const DEP_TYPE_IMAGE = 'image';
...
export const DEP_TYPE_REQUIRE = 'require';
export const DEP_TYPE_SERVICE_IMAGE = 'service-image';
export const DEP_TYPE_TERRAFORM = 'terraform';
export const DEP_TYPE_VOLTA = 'volta';

// Dep Action
export const DEP_ACTION_TERRAFORM = 'replace';

// Dep Status
export const DEP_STAGE_STAGED = 'stage';
export const DEP_STAGE_FINAL = 'final';
