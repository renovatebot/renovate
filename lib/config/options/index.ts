  ...
  */
  ...
  },
  {
    ...
    default: {
      ...
      ignoreDigest:
        'As this PR has been closed unmerged, Renovate will ignore this upgrade and you will not receive PRs for *any* future {{{depName}}}:{{{currentValue}}} digest updates - except if they would modify PR title or branch name. Digest updates will resume if you update the specified tag at any time.',
      ignoreOther:
