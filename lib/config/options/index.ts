...
const options: Readonly<RenovateOptions>[] = [
  ...
  },
  {
    ...
    type: 'string',
    default: 'ghcr.io/renovatebot/base-image:13.28.4',
    globalOnly: true,
    deprecationMsg:
      'The usage of `binarySource=docker` is deprecated, and will be removed in the future',
  },
...
export function registerManagerOptions(
  allManagers: ReadonlyMap<string, { defaultConfig?: Record<string, unknown> }>,
): void {
