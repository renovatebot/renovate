...
const options: RenovateOptions[] = [
  ...
  },
  {
    ...
    type: 'string',
    default: 'ghcr.io/containerbase/sidecar:9.23.7',
    globalOnly: true,
  },
  {
    name: 'dockerUser',
  ...
  */
  ...
  },
  {
    ...
    description:
      'If set to `true` then the `repoDir/.git-credentials` file will be used for platform authentication instead of embedding credentials in the URL.',
    type: 'boolean',
    default: false,
    advancedUse: true,
    supportedPlatforms: ['gitlab'],
