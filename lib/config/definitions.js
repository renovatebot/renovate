...
const options = [
  ...
  },
  {
    ...
    type: 'json',
    default: {
      filePattern: '^.circleci/config.yml$',
    },
    mergeable: true,
    cli: false,
  },
  {
    ...
    default: {
      enabled: false,
      filePattern: '(^|\\/)([\\w-]*)requirements.(txt|pip)$',
    },
    mergeable: true,
    cli: false,
  },
