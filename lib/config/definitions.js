...
const options = [
  ...
  {
    name: 'automerge',
    description: 'What types of upgrades to merge to base branch automatically. Values: none, patch, minor or any',
    type: 'string',
    default: 'none',
  },
  {
    name: 'prMergeMethod',
    description: 'Method of merging to perform. GitHub: merge, squash, rebase.',
    type: 'string',
    default: 'merge',
  },
  // String templates
