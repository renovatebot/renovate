...
const options = [
  ...
  },
  {
    name: 'assignees',
    description:
      'Assignees for Pull Request (with email in vsts, user name in GitHub)',
    type: 'list',
  },
  {
    name: 'reviewers',
    description:
      'Requested reviewers for Pull Requests (with email or user name in vsts, user name in GitHub)',
    type: 'list',
  },
  {
    name: 'npm',
