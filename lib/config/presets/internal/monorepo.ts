...
const patternGroups = {
  ...
  babel6: '^babel6$',
  clarity: ['^@cds/', '^@clr/'],
  'datatables-net-autofill': ['^datatables.net-autofill'],
  'datatables-net-buttons': ['^datatables.net-buttons'],
  'datatables-net-colreorder': ['^datatables.net-colreorder'],
  'datatables-net-fixedcolumns': ['^datatables.net-fixedcolumns'],
  'datatables-net-fixedheader': ['^datatables.net-fixedheader'],
  'datatables-net-keytable': ['^datatables.net-keytable'],
  'datatables-net-responsive': ['^datatables.net-responsive'],
  'datatables-net-rowgroup': ['^datatables.net-rowgroup'],
  'datatables-net-rowreorder': ['^datatables.net-rowreorder'],
  'datatables-net-scroller': ['^datatables.net-scroller'],
  'datatables-net-searchbuilder': ['^datatables.net-searchbuilder'],
  'datatables-net-searchpanes': ['^datatables.net-searchpanes'],
  'datatables-net-select': ['^datatables.net-select'],
  'datatables-net-staterestore': ['^datatables.net-staterestore'],
  embroider: '^@embroider/',
