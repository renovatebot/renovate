...
export const presets: Record<string, Preset> = {
  ...
  automergeOfficeHours: {
    ...
    description:
      'Schedule automerge during typical office hours on weekdays (i.e., 5 AM - 10 PM).',
  },
  automergeQuarterly: {
  ...
  officeHours: {
    description:
      'Schedule during typical office hours on weekdays (i.e., 5 AM - 10 PM).',
