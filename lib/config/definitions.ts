import * as appStrings from './app-strings';
...
const options: RenovateOptions[] = [
  ...
  {
    name: 'enabled',
    description: `Enable or disable ${appStrings.appName}`,
    stage: 'package',
    type: 'boolean',
    cli: false,
    env: false,
  ...
  },
  {
    ...
    type: 'string',
    default: `Update Dependencies (${appStrings.appName} Bot)`,
  },
  {
  ...
  },
  {
    ...
    type: 'string',
    default: `This PR has been generated by [${appStrings.appName} Bot](${appStrings.urls.homepage}).`,
    stage: 'global',
  },
  {
