...
describe('util/git/conflicts-cache', () => {
  ...
  describe('getCachedConflictResult', () => {
    ...
    it('returns null if base branch name does not match', () => {
      repoCache.branches = [
        partial<BranchCache>({
          baseBranchName: 'foo',
          branchName: 'aaa',
    ...
    it('returns null if base branch SHA does not match', () => {
      repoCache.branches = [
        partial<BranchCache>({
          baseBranchName: 'foo',
          branchName: 'aaa',
    ...
    it('returns null if brach sha does not match', () => {
      repoCache.branches = [
        partial<BranchCache>({
          baseBranchName: 'foo',
          branchName: 'bar',
    ...
    it('returns null if isConflicted value does not exist', () => {
      repoCache.branches = [
        partial<BranchCache>({
          baseBranchName: 'foo',
          branchName: 'bar',
    ...
    it('removes gitConflcits if it exists', () => {
      repoCache.branches = [
        partial<BranchCache>({
          baseBranchName: 'foo',
          branchName: 'bar',
  ...
  describe('setCachedConflictResult', () => {
    it('returns for unpopulated cache', () => {
