...
describe('versioning/rez/index', () => {
  ...
  test.each`
    ...
    ${'7.2..8'}          | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8..9'}
    ${'7.2.3..8'}        | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8..9'}
    ${'7..8.0'}          | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8.2..8.3'}
    ${'7.2..8.0'}        | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8.2..8.3'}
    ${'7.2.3..8.0'}      | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8.2..8.3'}
    ${'7..8.0.0'}        | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8.2..8.3'}
    ${'7.2..8.0.0'}      | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8.2..8.3'}
    ${'7.2.3..8.0.0'}    | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'8.2.0..8.3.0'}
    ...
    ${'>7.1,<8'}         | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8,<9'}
    ${'>7.2.0,<8'}       | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8,<9'}
    ${'>6,<8.0'}         | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8.2,<8.3'}
    ${'>7.1,<8.0'}       | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8.2,<8.3'}
    ${'>7.2.0,<8.0'}     | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8.2,<8.3'}
    ${'>6,<8.0.0'}       | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8.2,<8.3'}
    ${'>7.1,<8.0.0'}     | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8.2,<8.3'}
    ${'>7.2.0,<8.0.0'}   | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'>8.2.0,<8.3.0'}
    ...
    ${'<8,>=7.2'}        | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<9,>=8'}
    ${'<8,>=7.2.3'}      | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<9,>=8'}
    ${'<8.0,>=7'}        | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>=8.2'}
    ${'<8.0,>=7.2'}      | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>=8.2'}
    ${'<8.0,>=7.2.3'}    | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>=8.2'}
    ${'<8.0.0,>=7'}      | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>=8.2'}
    ${'<8.0.0,>=7.2'}    | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>=8.2'}
    ${'<8.0.0,>=7.2.3'}  | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3.0,>=8.2.0'}
    ...
    ${'<8,>7.1'}         | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<9,>8'}
    ${'<8,>7.2.0'}       | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<9,>8'}
    ${'<8.0,>6'}         | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>8.2'}
    ${'<8.0,>7.1'}       | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>8.2'}
    ${'<8.0,>7.2.0'}     | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>8.2'}
    ${'<8.0.0,>6'}       | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>8.2'}
    ${'<8.0.0,>7.1'}     | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3,>8.2'}
    ${'<8.0.0,>7.2.0'}   | ${'replace'}  | ${'7.2.3'}     | ${'8.2.5'} | ${'<8.3.0,>8.2.0'}
