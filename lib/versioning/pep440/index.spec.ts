...
describe(getName(), () => {
  ...
  describe('pep.isLessThanRange()', () => {
    test.each([
      ...
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '0.9.9.9', true],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '1.0.0a0', true],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '1.0.0.0', false],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '1.2.2.9', false],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '1.2.3.0', false],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '1.2.3a0', false],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '1.2.3.1', false],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '2.0.0.0', false],
      ['>= 1.0.0, < 2.0.0, != 1.2.3', '2.0.0a0', false],
