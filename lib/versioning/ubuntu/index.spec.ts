...
describe('versioning/ubuntu', () => {
  ...
  it('isValid', () => {
    ...
    expect(ubuntu.isValid('warty')).toBe(false);
    expect(ubuntu.isValid('WaRtY')).toBe(false);
    expect(ubuntu.isValid('hoary')).toBe(false);
    expect(ubuntu.isValid('breezy')).toBe(false);
    expect(ubuntu.isValid('dapper')).toBe(false);
    expect(ubuntu.isValid('edgy')).toBe(false);
    expect(ubuntu.isValid('feisty')).toBe(false);
    expect(ubuntu.isValid('gutsy')).toBe(false);
    expect(ubuntu.isValid('hardy')).toBe(false);
    expect(ubuntu.isValid('intrepid')).toBe(false);
    expect(ubuntu.isValid('jaunty')).toBe(false);
    expect(ubuntu.isValid('karmic')).toBe(false);
    expect(ubuntu.isValid('lucid')).toBe(false);
    expect(ubuntu.isValid('maverick')).toBe(false);
    expect(ubuntu.isValid('natty')).toBe(false);
    expect(ubuntu.isValid('oneiric')).toBe(false);
    expect(ubuntu.isValid('precise')).toBe(false);
    expect(ubuntu.isValid('quantal')).toBe(false);
    expect(ubuntu.isValid('raring')).toBe(false);
    expect(ubuntu.isValid('saucy')).toBe(false);
    expect(ubuntu.isValid('trusty')).toBe(false);
    expect(ubuntu.isValid('utopic')).toBe(false);
    expect(ubuntu.isValid('vivid')).toBe(false);
    expect(ubuntu.isValid('wily')).toBe(false);
    expect(ubuntu.isValid('xenial')).toBe(false);
    expect(ubuntu.isValid('yakkety')).toBe(false);
    expect(ubuntu.isValid('zesty')).toBe(false);
    expect(ubuntu.isValid('artful')).toBe(false);
    expect(ubuntu.isValid('bionic')).toBe(false);
    expect(ubuntu.isValid('cosmic')).toBe(false);
    expect(ubuntu.isValid('disco')).toBe(false);
    expect(ubuntu.isValid('eoan')).toBe(false);
    expect(ubuntu.isValid('focal')).toBe(false);
    expect(ubuntu.isValid('groovy')).toBe(false);
