...
export const isVersion = version => !!valid(version);
...
export const matches = (version, range) => satisfies(version, range);
...
export const sortVersions = (left, right) => (gt(left, right) ? 1 : -1);
