  ...
  describe('.getNewValue', () => {
    ...
    it('returns correct version for bump strategy', () => {
      [
        ...
        ['<= 1.2.3', '<= 1.0.3', 'bump', '1.0.3', '1.2.3'],
        ['~> 1.2.3', '~> 1.0.3', 'bump', '1.0.3', '1.2.3'],
        ['~> 1.0.4', '~> 1.0.3', 'bump', '1.0.3', '1.0.4'],
        ['~> 4.7, >= 4.7.9', '~> 4.7, >= 4.7.4', 'bump', '4.7.5', '4.7.9'],
        ['~> 4.7, >= 4.7.9', '~> 4.7', 'bump', '4.7.5', '4.7.9'],
        ['~> 4.8', '~> 4.7, >= 4.7.4', 'bump', '4.7.5', '4.8.0'],
    ...
    it('returns correct version for replace strategy', () => {
      [
        ...
        ['~> 6.0.2, >= 6.0.2.1', '~> 5.2.0', 'replace', '5.2.4.1', '6.0.2.1'],
        ['~> 5.0, < 6', '~> 4.0, < 5', 'replace', '4.7.5', '5.0.0'],
        ['~> 5.0, >= 5.0.1, < 6', '~> 4.0, < 5', 'replace', '4.7.5', '5.0.1'],
