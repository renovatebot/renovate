...
function capRange(currentValue, toVersion) {
...
function getNewValue(currentValue, rangeStrategy, fromVersion, toVersion) {
  if (rangeStrategy === 'cap') {
    ...
    const newCapValue = capRange(newValue, toVersion);
    // console.log([newValue, newCapValue]);
    if (newValue === newCapValue) {
      return capRange(currentValue, toVersion);
    }
    return newCapValue;
  }
