...
async function mergeBranch(branchName) {
  ...
  if (!isCloud) {
    logger.debug({ mergeBranch: branchName }, 'ABOUTTOMERGE');
    const prList = await getPrList();
    const prForBranch = prList.find(x => x.branchName === branchName);
    ...
    /*
    DEBUG: PRFORBRANCH (repository=cd/mock-library-nodejs, dependencies=mocha, branch=renovate/mocha-5.x)
       "prForBranch": {
         "version": 2,
         "number": 18,
         "body": "This PR contains the following updates:\n\n| Package | Type | Update | Change | References |\n|---|---|---|
    ---|---|\n| mocha | devDependencies | major | `2.5.3` -> `5.2.0` | [homepage](https://mochajs.org), [source](https://github.c
    om/mochajs/mocha) |\n\n---\n\n### Renovate configuration\n\n:date: **Schedule**: At any time (no schedule defined).\n\n:verti
    cal_traffic_light: **Automerge**: Enabled.\n\n:recycle: **Rebasing**: Whenever PR becomes conflicted.\n\n:no_bell: **Ignore**
    : Close this PR and you won't be reminded about this update again.\n\n---\n\nThis PR has been generated by [Renovate Bot](htt
    ps://renovatebot.com).",
             "branchName": "renovate/mocha-5.x",
             "title": "Update dependency mocha to v5",
             "state": "open"
           }
    DEBUG: Pull Request #18 does not need updating (repository=cd/mock-library-nodejs, dependencies=mocha, branch=renovate/mocha-
    5.x)
    DEBUG: Checking #18 for automerge (repository=cd/mock-library-nodejs, dependencies=mocha, branch=renovate/mocha-5.x)
           "automerge": true,
           "automergeType": "pr",
           "automergeComment": "automergeComment"
    DEBUG: PR is configured for automerge (repository=cd/mock-library-nodejs, dependencies=mocha, branch=renovate/mocha-5.x)
     INFO: PR is not ready for merge (repository=cd/mock-library-nodejs, dependencies=mocha, branch=renovate/mocha-5.x)

     TODO: bbServer supports PR checks and we can theoretically auto merge, but somehow renovate expects pr.canMerge and we dont know how to expose it yet
    */
