...
module.exports = {
  // vsts App
  getInstallations,             //not in VSTS
  getInstallationToken,         //not in VSTS
  getInstallationRepositories,  //not in VSTS
  // Initialization
  getRepos,                     //not in VSTS
  initRepo,                     //done
  setBaseBranch,                //done
  // Search
  findFilePaths,                //done
  // Branch
  branchExists,                 //done
  getAllRenovateBranches,       //not done
  isBranchStale,                //done?
  getBranchPr,                  //not done
  getBranchStatus,
  deleteBranch,
  mergeBranch,
  createBranch,
