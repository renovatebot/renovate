...
async function ensureOnboardingPr(config) {
  ...
  if (config.requireConfig) {
    prTemplate += `Renovate will begin keeping your dependencies up-to-date only once you merge this Pull Request.\nIf you close this Pull Request unmerged, then Renovate will be disabled.\n\n`;
  } else {
    prTemplate += `Renovate will begin keeping your dependencies up-to-date only once you merge or close this Pull Request.\n\n`;
  }
