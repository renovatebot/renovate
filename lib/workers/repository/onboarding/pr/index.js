...
async function ensureOnboardingPr(config, packageFiles, branches) {
  ...
  let prTemplate = `Welcome to [${appName}](${appUrl})! This is an onboarding PR to help you understand and configure settings before regular Pull Requests begin.\n\n`;
...
:question: If you have any questions, try reading the [Docs](${docsUrl}), particularly the Getting Started section.
Also, you can post questions about your config in [${appName}'s Config Help repository](https://github.com/renovatebot/config-help/issues).
`;
  ...
  if (!existingPr || existingPr.canRebase) {
    ...
    configDesc = `### Configuration\n\n:abcd: ${appName} has detected a custom config for this PR. Feel free to post it to the [Config Help repository](https://github.com/renovatebot/config-help/issues) if you have any doubts and would like it reviewed.\n\n`;
