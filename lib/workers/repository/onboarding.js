...
`;
  ...
  if (description.length) {
    let configDesc = `---\n\n## Configuration Summary\n\nBased on the currently configured presets, you should expect to see the following behaviour:\n<ul>\n`;
    configDesc +=
      '  <li>Start dependency updates once this Configure Renovate PR is closed</li>\n';
