...
async function ensurePr(config, upgradeData) {
  const branchUpgrades = upgradeData.branchUpgrades;
  const warnings = upgradeData.warnings;
  const errors = upgradeData.errors;
