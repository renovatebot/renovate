...
/**
 * Shared implementation for the Gitea-compatible changelog sources.
 *
 * Forgejo is a fork of Gitea and serves the same API, so both sources only
 * differ in the `Http` instance they pass in.
 */
