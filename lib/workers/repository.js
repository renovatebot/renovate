// Child functions
const detectPackageFiles = require('./repository/detect-package-files');
const mergeRenovateJson = require('./repository/merge-renovate-json');
const onboarding = require('./repository/onboarding');
const initApis = require('./repository/init-apis');
const determineRepoUpgrades = require('./repository/determine-repo-upgrades');
const groupUpgradesByBranch = require('./repository/group-upgrades-by-branch');
const updateBranchesSequentially = require('./repository/update-branches-sequentially');
