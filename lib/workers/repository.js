...
async function processRepo(config, parentLogger) {
  logger = parentLogger.child({ repository: config.repository });
  logger.info(`Processing repository ${config.repository}`);
