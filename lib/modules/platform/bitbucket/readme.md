...
Read the [Security and Permissions](https://docs.renovatebot.com/security-and-permissions/) page to learn about the Security and Permissions needed for the Mend app.
