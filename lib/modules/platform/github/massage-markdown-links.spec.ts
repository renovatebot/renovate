...
describe('modules/platform/github/massage-markdown-links', () => {
  ...
  test.each`
    ...
    ${'github.com/Foo/bar/pull/1'}                                                            | ${'[Foo/bar#1](togithub.com/Foo/bar/pull/1)'}
    ${'github.com/Foo/bar.ab/pull/1'}                                                         | ${'[Foo/bar.ab#1](togithub.com/Foo/bar.ab/pull/1)'}
    ${'github.com/Foo/bar-ab/pull/1'}                                                         | ${'[Foo/bar-ab#1](togithub.com/Foo/bar-ab/pull/1)'}
    ...
    ${'www.github.com/foo/bar.ab/pull/1'}                                                     | ${'[foo/bar.ab#1](www.togithub.com/foo/bar.ab/pull/1)'}
    ${'www.github.com/foo/bar-ab/pull/1'}                                                     | ${'[foo/bar-ab#1](www.togithub.com/foo/bar-ab/pull/1)'}
    ...
    ${'https://github.com/foo/bar.ab/pull/1'}                                                 | ${'[foo/bar.ab#1](https://togithub.com/foo/bar.ab/pull/1)'}
    ${'https://github.com/foo/bar-ab/pull/1'}                                                 | ${'[foo/bar-ab#1](https://togithub.com/foo/bar-ab/pull/1)'}
    ...
    ${'https://github.com/foo/bar.ab/pull/1#comment-123'}                                     | ${'[foo/bar.ab#1#comment-123](https://togithub.com/foo/bar.ab/pull/1#comment-123)'}
    ${'https://github.com/foo/bar-ab/pull/1#comment-123'}                                     | ${'[foo/bar-ab#1#comment-123](https://togithub.com/foo/bar-ab/pull/1#comment-123)'}
    ...
    ${'[https://github.com/ab-cd/ab.cd/pull/254](https://github.com/ab-cd/ab.cd/pull/254)'}   | ${'[https://github.com/ab-cd/ab.cd/pull/254](https://togithub.com/ab-cd/ab.cd/pull/254)'}
    ${'[https://github.com/ab-cd/ab-cd/pull/254](https://github.com/ab-cd/ab-cd/pull/254)'}   | ${'[https://github.com/ab-cd/ab-cd/pull/254](https://togithub.com/ab-cd/ab-cd/pull/254)'}
  `(
    '$input -> $output',
