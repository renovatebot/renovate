...
describe('modules/platform/space/client/repository', () => {
  ...
  describe('getByName()', () => {
    it('should get repository details', async () => {
      ...
      httpMock
        ...
        .reply(200, expected, jsonResultHeader);
  ...
  describe('getFileContent', () => {
    it('should get file content', async () => {
      ...
      const actual = await client.getFileContent(
        projectKey,
        repository,
        path,
        commit,
...
function mockRepositoriesPage(
  repos: SpaceRepositoryBasicInfo[],
  next: string,
  nextQuery?: string,
) {
...
function mockBranchesHeadsPage(
  projectKey: string,
  repository: string,
  heads: SpaceBranchHead[],
  next: string,
  nextQuery?: string,
) {
