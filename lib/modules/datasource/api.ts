...
import { BufModuleDatasource } from './buf-module/index.ts';
import { BufPluginDatasource } from './buf-plugin/index.ts';
...
api.set(BufModuleDatasource.id, new BufModuleDatasource());
api.set(BufPluginDatasource.id, new BufPluginDatasource());
