...
describe('modules/datasource/devbox/index', () => {
  ...
  it('processes real data', async () => {
    ...
    expect(res).toEqual({
      ...
      releases: [
        { version: '21.7.3', releaseTimestamp: '2024-04-19T21:36:04.000Z' },
        { version: '22.0.0', releaseTimestamp: '2024-05-12T16:19:40.000Z' },
        { version: '22.2.0', releaseTimestamp: '2024-05-22T06:18:38.000Z' },
      ],
    });
  });
