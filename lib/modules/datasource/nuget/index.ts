...
export class NugetDatasource extends Datasource {
  ...
  override readonly releaseTimestampNote =
    'For the v2 API, the release timestamp is determined from the `Publised` tag. And, for the v3 API, the release timestamp is determined from the `published` field in the results.';
