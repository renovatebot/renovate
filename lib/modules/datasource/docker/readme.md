...
The [Label Schema](https://github.com/label-schema/label-schema.org) is superseded by OCI annotations, use the `org.opencontainers.image.source` label if possible.
