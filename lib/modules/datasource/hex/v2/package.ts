...
// versions:
// protoc-gen-ts_proto v1.178.0 protoc v6.33.4
...
export type RetirementReason = typeof RetirementReason[keyof typeof RetirementReason];

export namespace RetirementReason {
  export type RETIRED_OTHER = typeof RetirementReason.RETIRED_OTHER;
  export type RETIRED_INVALID = typeof RetirementReason.RETIRED_INVALID;
  export type RETIRED_SECURITY = typeof RetirementReason.RETIRED_SECURITY;
  export type RETIRED_DEPRECATED = typeof RetirementReason.RETIRED_DEPRECATED;
  export type RETIRED_RENAMED = typeof RetirementReason.RETIRED_RENAMED;
  export type UNRECOGNIZED = typeof RetirementReason.UNRECOGNIZED;
}
