...
export class GiteaTagsDatasource extends GitHostTagsDigestDatasource {
  ...
  protected readonly cacheNamespace: PackageCacheNamespace = `datasource-${GiteaTagsDatasource.id}`;
  ...
  getRegistryUrl(registryUrl?: string): string {
    return GiteaTagsDatasource.getRegistryURL(registryUrl);
  }
