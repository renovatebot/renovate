      ...
      expect(res).toMatchSnapshot({
        ...
        deps: [
          ...
          },
          {
            ...
            depName: 'django',
            depType: 'packages',
            packageName: 'https://github.com/django/django.git',
          },
          { depName: 'flask', skipReason: 'any-version' },
          {
            currentValue: '1.8.0',
            datasource: 'git-tags',
            depName: 'python-gitlab',
            depType: 'packages',
            packageName: 'https://gitlab.com/python-gitlab/python-gitlab',
          },
          { depName: 'malformed-url', skipReason: 'invalid-name' },
          { depName: 'http-url', skipReason: 'invalid-name' },
