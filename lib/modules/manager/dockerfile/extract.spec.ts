      ...
      expect(res).toEqual([
        {
          ...
          registryUrls: ['https://registry2.something.info'],
          depType: 'final',
      ...
      expect(res).toEqual([
        {
          ...
          registryUrls: ['https://registry2.something.info:5005'],
          depType: 'final',
      ...
      expect(res).toEqual([
        {
          ...
          registryUrls: ['https://quay.io:1234'],
      ...
      expect(res).toEqual([
        {
          ...
          registryUrls: ['https://registry.allmine.info:5005'],
          depType: 'final',
