...
describe('modules/manager/puppet/puppetfile-parser', () => {
  describe('parsePuppetfile()', () => {
    it('Puppetfile_git_tag', () => {
      ...
      expect(defaultRegistryModules[0].tags.get('git')).toBe('https://github.com/puppetlabs/puppetlabs-apache');
      ...
      expect(defaultRegistryModules[1].tags.get('git')).toBe('git@github.com:puppetlabs/puppetlabs-stdlib.git');
    ...
    it('Puppetfile_multiple_forges', () => {
      ...
      const someOtherPuppetForgeModules = puppetfile.get('https://some-other-puppet-forge.com');
