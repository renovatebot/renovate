  ...
  describe('.extractPackageFile()', () => {
    ...
    it('extracts volta', async () => {
      ...
      expect(res).toEqual({
        ...
        extractedConstraints: { node: '8.9.2' },
        managerData: {
          hasPackageManager: false,
          npmLock: undefined,
          npmrcFileName: undefined,
      ...
      expect(res).toEqual({
        deps: [
          ...
          },
          {
            ...
            currentRawValue:
              'github:owner/e#49b5aca613b33c5b626ae68c03a385f25c142f55',
            currentValue: null,
            datasource: 'github-tags',
            depName: 'e',
            depType: 'dependencies',
          ...
          {
            currentRawValue: 'github:owner/repo.with.dots#v1.0.0',
            currentValue: 'v1.0.0',
            datasource: 'github-tags',
            depName: 's',
            depType: 'dependencies',
          ...
          {
            currentRawValue: 'git@github.com:owner/repo.with.dots.git#v1.0.0',
            currentValue: 'v1.0.0',
            datasource: 'github-tags',
            depName: 't',
            depType: 'dependencies',
