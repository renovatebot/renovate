...
- `yarn.catalog.list.<name>`, such as `yarn.catalog.list.default` and `yarn.catalog.list.myCatalog` if you are using the [yarn-plugin-catalogs](https://github.com/toss/yarn-plugin-catalogs)
