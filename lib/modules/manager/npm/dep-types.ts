...
export const supportsDynamicDepTypesNote =
  'Additionally, catalog dependencies produce dynamic `depType` values: `bun.catalog.<name>` for [bun catalogs](https://bun.sh/docs/install/catalogs), `pnpm.catalog.<name>` for [pnpm catalogs](https://pnpm.io/catalogs#defining-catalogs), and `yarn.catalog.<name>` for [yarn catalogs](https://yarnpkg.com/features/catalogs).';
