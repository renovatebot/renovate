...
export const urls = [
  '[NuGet Package Versioning Documentation - Microsoft](https://docs.microsoft.com/en-us/nuget/concepts/package-versioning)',
  '[NuGet Tools - Azure Websites](https://nugettools.azurewebsites.net/)',
];
