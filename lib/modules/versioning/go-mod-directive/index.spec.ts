...
describe('modules/versioning/go-mod-directive/index', () => {
  ...
  it.each`
    ...
    ${'1.16'}    | ${'bump'}     | ${'1.16.4'}    | ${'1.21.3'} | ${'1.21'}
    ${'1.20'}    | ${'bump'}     | ${'1.20.2'}    | ${'1.21.1'} | ${'1.21'}
    ${'1.21.2'}  | ${'bump'}     | ${'1.21.2'}    | ${'1.21.3'} | ${'1.21.3'}
    ${'1.16'}    | ${'replace'}  | ${'1.16.4'}    | ${'1.16.4'} | ${'1.16'}
    ${'1.16'}    | ${'replace'}  | ${'1.21.2'}    | ${'1.21.2'} | ${'1.21'}
    ${'1.20'}    | ${'replace'}  | ${'1.20.2'}    | ${'1.21.3'} | ${'1.21'}
    ${'1.21.2'}  | ${'replace'}  | ${'1.21.2'}    | ${'1.21.3'} | ${'1.21.3'}
    ${'1.16'}    | ${'widen'}    | ${'1.16.4'}    | ${'1.16.4'} | ${'1.16'}
    ${'1.16'}    | ${'widen'}    | ${'1.16.4'}    | ${'1.21.3'} | ${'1.16'}
  `(
