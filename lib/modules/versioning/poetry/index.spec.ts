...
import { poetry2npm } from './transform.ts';
...
describe('modules/versioning/poetry/index', () => {
  describe('poetry2npm', () => {
    it.each`
      ...
      ${'^3.11b1'}             | ${'^3.11.0-b.1'}
      ${'^3.11rc1'}            | ${'^3.11.0-rc.1'}
      ${'^0.43b0 || >=0.44b0'} | ${'^0.43.0-b.0 || >=0.44.0-b.0'}
      ${'^0.43b0, <0.44'}      | ${'^0.43.0-b.0 <0.44'}
      ${'^0.43.*'}             | ${'^0.43.*'}
      ${'^1!0.43b0'}           | ${'^1!0.43b0'}
      ${'^0.43b0+local'}       | ${'^0.43b0+local'}
      ${'^0.43b0.dev1'}        | ${'^0.43b0.dev1'}
      ${'^0.43b0.post1'}       | ${'^0.43b0.post1'}
    `('poetry2npm("$input") === "$expected"', ({ input, expected }) => {
      expect(poetry2npm(input)).toBe(expected);
    });
  });
  ...
  it.each`
    ...
    ${'0.43b1'}  | ${'~=0.43b0'}             | ${true}
    ${'0.43b1'}  | ${'>=0.43b0'}             | ${true}
    ${'0.44b1'}  | ${'^0.43b0 || >=0.44b0'}  | ${true}
    ${'0.43b1'}  | ${'^0.43b0, <0.44'}       | ${true}
    ${'3.12'}    | ${'^3.11'}                | ${true}
    ${'1.4'}     | ${'1.4'}                  | ${true}
  `(
  ...
  it.each`
    ...
    ${'^0.43b0'}        | ${'replace'}  | ${'0.43b0'}        | ${'0.43b1'}        | ${'^0.43b0'}
    ${'^0.43b0'}        | ${'replace'}  | ${'0.43b0'}        | ${'0.45b0'}        | ${'^0.45.0-beta'}
    ${'^0.43b0'}        | ${'replace'}  | ${undefined}       | ${'0.45b0'}        | ${'^0.43b0'}
    ${'^0.43b0'}        | ${'replace'}  | ${'0.43b0'}        | ${'0.45.0'}        | ${'^0.45.0'}
    ${'^3.11b1'}        | ${'replace'}  | ${'3.11b1'}        | ${'3.12rc1'}       | ${'^3.12.0-rc'}
