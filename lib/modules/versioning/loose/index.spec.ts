...
describe('modules/versioning/loose/index', () => {
  ...
  it.each`
    ...
    ${'2.4.1'}                  | ${'2.4'}                    | ${false}
    ${'2.4.2'}                  | ${'2.4.1'}                  | ${false}
    ${'2026051723231779060202'} | ${'2026051723231779060202'} | ${true}
    ${'2026051723231779060208'} | ${'2026051723231779060202'} | ${false}
  ...
  it.each`
    ...
    ${'2026051723231779060208'}     | ${'2026051723231779060202'}     | ${true}
    ${'2026051723231779060202'}     | ${'2026051723231779060208'}     | ${false}
