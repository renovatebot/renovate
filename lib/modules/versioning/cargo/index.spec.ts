...
describe('modules/versioning/cargo/index', () => {
  ...
  it.each`
    ...
    ${'^0.33.0'}             | ${'widen'}    | ${'0.33.0'}    | ${'0.34.1'}     | ${'>=0.33.0, <0.35.0'}
    ${'0.33'}                | ${'widen'}    | ${'0.33.0'}    | ${'0.34.1'}     | ${'>=0.33.0, <0.35.0'}
    ${'^1.0.0'}              | ${'widen'}    | ${'1.0.0'}     | ${'2.0.7'}      | ${'>=1.0.0, <3.0.0'}
    ${'1.0.0'}               | ${'widen'}    | ${'1.0.0'}     | ${'2.0.7'}      | ${'>=1.0.0, <3.0.0'}
    ${'~1.2.3'}              | ${'widen'}    | ${'1.2.3'}     | ${'1.5.0'}      | ${'>=1.2.3, <1.6.0'}
    ${'>=1.0.0, <2.0.0'}     | ${'widen'}    | ${'1.0.0'}     | ${'2.0.7'}      | ${'>=1.0.0, <3.0.0'}
    ${'^1.0.0'}              | ${'widen'}    | ${'1.0.0'}     | ${'1.5.0'}      | ${'^1.0.0'}
    ${'>=1.0.0'}             | ${'widen'}    | ${'1.0.0'}     | ${'0.5.0'}      | ${'>=1.0.0'}
    ${'>1.0.0'}              | ${'widen'}    | ${'1.0.0'}     | ${'0.5.0'}      | ${'>1.0.0'}
  `(
