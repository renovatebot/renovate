...
describe('modules/versioning/npm/index', () => {
  ...
  it.each`
    ...
    ${'>= 0.1.21 < 0.2.0'}  | ${'replace'}         | ${'0.1.21'}      | ${'0.2.0'}              | ${'>= 0.2.0 < 0.3.0'}
    ${'>= 0.1.21 < 0.1.26'} | ${'replace'}         | ${'0.1.21'}      | ${'0.1.29'}             | ${'>= 0.1.29 < 0.2.0'}
    ${'>= 1.0.0 < 2.0.0'}   | ${'replace'}         | ${'1.1.21'}      | ${'2.0.0'}              | ${'>= 2.0.0 < 3.0.0'}
    ${'>= 1.0.0 < 3.0.0'}   | ${'replace'}         | ${'1.1.21'}      | ${'3.0.0'}              | ${'>= 3.0.0 < 4.0.0'}
    ${'>= 0.1.21 <= 0.2.0'} | ${'bump'}            | ${'0.1.21'}      | ${'0.1.24'}             | ${'>= 0.1.24 <= 0.2.0'}
