...
describe('modules/versioning/hex/index', () => {
  ...
  it.each`
    ...
    ${'v1.2.3'}                | ${'pin'}             | ${'1.2.3'}     | ${'v1.2.4'} | ${'v1.2.4'}
    ${'v1.2.3'}                | ${'replace'}         | ${'1.2.3'}     | ${'v1.2.4'} | ${'v1.2.4'}
    ${'v1.2.3'}                | ${'bump'}            | ${'1.2.3'}     | ${'v1.2.4'} | ${'v1.2.4'}
    ${'v1.2.3'}                | ${'update-lockfile'} | ${'1.2.3'}     | ${'v1.2.4'} | ${'v1.2.4'}
    ${'v1.2.3'}                | ${'widen'}           | ${'1.2.3'}     | ${'v1.2.4'} | ${'v1.2.4'}
  `(
