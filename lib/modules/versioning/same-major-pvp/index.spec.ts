...
describe('modules/versioning/same-major-pvp/index', () => {
  describe('.isGreaterThan(version, other)', () => {
    it('should return true', () => {
      expect(sameMajor.isGreaterThan('1.23.1', '1.9.6')).toBeTrue(); // this demonstrates the difference with same-major (no pvp)
      expect(sameMajor.isGreaterThan('4.0.0', '3.0.0')).toBeTrue(); // greater
    });

    it('should return false', () => {
      expect(sameMajor.isGreaterThan('2.0.2', '3.1.0')).toBeFalse(); // less
      expect(sameMajor.isGreaterThan('3.0.1', '3.0.0')).toBeFalse(); // same major -> equal
