...
import * as rustToolchainNightly from './rust-toolchain-nightly';
import * as sameMajor from './same-major';
import * as semver from './semver';
import * as semverCoerced from './semver-coerced';
import * as semverPartial from './semver-partial';
...
api.set(rustToolchainNightly.id, rustToolchainNightly.api);
