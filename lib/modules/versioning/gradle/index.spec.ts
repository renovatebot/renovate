import { compare, parseMavenBasedRange, parsePrefixRange } from './compare.ts';
...
describe('modules/versioning/gradle/index', () => {
  ...
  describe('getNewValue', () => {
    it.each`
      ...
      ${'[1.2.3,)'}                 | ${'pin'}      | ${'1.2.3'}     | ${'1.2.4'}  | ${'1.2.4'}
      ${'[1.2.3,['}                 | ${'pin'}      | ${'1.2.3'}     | ${'1.2.4'}  | ${'1.2.4'}
      ${'(,1.0]!!1.0'}              | ${'pin'}      | ${'1.0.1'}     | ${'2.0'}    | ${'2.0'}
      ${'],1.0]!!1.0'}              | ${'pin'}      | ${'0.0.1'}     | ${'2.0'}    | ${'2.0'}
      ${'(,1.0)!!1.0'}              | ${'pin'}      | ${'0.1'}       | ${'2.0'}    | ${'2.0'}
      ${'],1.0[!!1.0'}              | ${'pin'}      | ${'2.0'}       | ${'],2.0['} | ${'],2.0['}
      ${'[1.0,1.2],[1.3,1.5)!!1.0'} | ${'pin'}      | ${'1.0'}       | ${'1.2.4'}  | ${'1.2.4'}
      ${'[1.0,1.2],[1.3,1.5[!!1.0'} | ${'pin'}      | ${'1.0'}       | ${'1.2.4'}  | ${'1.2.4'}
      ${'[1.2.3,)!!1.2.3'}          | ${'pin'}      | ${'1.2.3'}     | ${'1.2.4'}  | ${'1.2.4'}
      ${'[1.2.3,[!!1.2.3'}          | ${'pin'}      | ${'1.2.3'}     | ${'1.2.4'}  | ${'1.2.4'}
      ...
      ${'[1.2.3,)'}                 | ${'bump'}     | ${'1.2.3'}     | ${'1.2.4'}  | ${'[1.2.4,)'}
      ${'[1.2.3,['}                 | ${'bump'}     | ${'1.2.3'}     | ${'1.2.4'}  | ${'[1.2.4,['}
      ${'(,1.0]!!1.0'}              | ${'bump'}     | ${'0.0.1'}     | ${'2.0'}    | ${'(,2.0]!!2.0'}
      ${'],1.0]!!1.0'}              | ${'bump'}     | ${'0.0.1'}     | ${'2.0'}    | ${'],2.0]!!2.0'}
      ${'(,1.0)!!1.0'}              | ${'bump'}     | ${'0.1'}       | ${'2.0'}    | ${'(,3.0)!!2.0'}
      ${'],1.0[!!1.0'}              | ${'bump'}     | ${'2.0'}       | ${'],2.0['} | ${'],1.0[!!1.0'}
      ${'[1.0,1.2],[1.3,1.5)!!1.0'} | ${'bump'}     | ${'1.0'}       | ${'1.2.4'}  | ${'[1.0,1.2],[1.3,1.5)!!1.0'}
      ${'[1.0,1.2],[1.3,1.5[!!1.0'} | ${'bump'}     | ${'1.0'}       | ${'1.2.4'}  | ${'[1.0,1.2],[1.3,1.5[!!1.0'}
