...
describe('modules/versioning/oci-helm/index', () => {
  ...
  it.each`
    ...
    ${['0.1.0-1686130589', '0.1.1-1686130589_build1-7aebcdf']}                             | ${'*'}                 | ${'0.1.1-1686130589_build1-7aebcdf'} | ${'0.1.0-1686130589'}
    ...
    ${['0.0.1', '0.1.1-1686130589_7aebcdf', '0.4.1', '1.0.0-1686130637_ld3fn0s']}          | ${'*-0'}               | ${'1.0.0-1686130637_ld3fn0s'}        | ${'0.1.1-1686130589_7aebcdf'}
    ${['0.0.1', '0.1.1-1686130589_7aebcdf', '0.4.1', '1.0.0-1686130637_ld3fn0s', '2.0.0']} | ${'*-0'}               | ${'2.0.0'}                           | ${'0.1.1-1686130589_7aebcdf'}
  `(
