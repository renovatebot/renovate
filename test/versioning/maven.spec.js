...
describe('versioning/maven/index', () => {
  it('validates version string', () => {
    ...
    expect(isVersion('v1.0.0')).toEqual(false);
  ...
  it('checks if version is stable', () => {
    ...
    expect(isStable('v1.0.0')).toEqual(null);
  ...
  it('returns major version', () => {
    ...
    expect(getMajor('v1.0.0')).toEqual(null);
  ...
  it('returns minor version', () => {
    ...
    expect(getMinor('v1.0.0')).toEqual(null);
  ...
  it('returns patch version', () => {
    ...
    expect(getPatch('v1.0.0')).toEqual(null);
