...
const res1 = fs.readFileSync(
  'test/datasource/_fixtures/pypi/azure-cli-monitor.json'
);
const htmlResponse = fs.readFileSync(
  'test/datasource/_fixtures/pypi/versions-html.html'
);
const badResponse = fs.readFileSync(
  'test/datasource/_fixtures/pypi/versions-html-badfile.html'
);
