...
import qJson from '../../../../../lib/config/npm/__fixtures__/01.json';
import helmetJson from '../../../../../lib/config/npm/__fixtures__/02.json';
import coffeelintJson from '../../../../../lib/config/npm/__fixtures__/coffeelint.json';
import webpackJson from '../../../../../lib/config/npm/__fixtures__/webpack.json';
import nextJson from '../../../../../lib/config/npm/__fixtures__/next.json';
import vueJson from '../../../../../lib/config/npm/__fixtures__/vue.json';
import typescriptJson from '../../../../../lib/config/npm/__fixtures__/typescript.json';
