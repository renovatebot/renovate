...
import { doAutoReplace } from '../../../lib/workers/branch/auto-replace';
import { defaultConfig } from '../../util';
import { RenovateConfig } from '../../../lib/config';
import { extractPackageFile } from '../../../lib/manager/html';

const sampleHtml = readFileSync(
  resolve(__dirname, `../../../lib/manager/html/__fixtures__/sample.html`),
  'utf8'
);
