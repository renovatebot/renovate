...
<tr>
  <td>`assignees`</td>
  <td>Assignees for Pull Request (with email in vsts, user name in GitHub)</td>
  <td>list</td>
  <td><pre>[]</pre></td>
...
<tr>
  <td>`reviewers`</td>
  <td>Requested reviewers for Pull Requests (with email or user name in vsts, user name in GitHub)</td>
  <td>list</td>
  <td><pre>[]</pre></td>
