...
$ node renovate --help
  ...
  Options:
    ...
    --upgrade-versions [boolean]         Upgrade existing dependency versions if found
...
<tr>
  <td>`upgradeVersions`</td>
  <td>Upgrade existing dependency versions if found</td>
  <td>boolean</td>
  <td><pre>true</pre></td>
  <td>`RENOVATE_UPGRADE_VERSIONS`</td>
  <td>`--upgrade-versions`<td>
</tr>
<tr>
