...
Where you can find the logs depends on how you are running Renovate.
...
Once you are logged in, you can see the logs for the Renovate jobs on your repository.
