...
- On GitHub, GitLab, Gitea and Forgejo: Renovate will keep PR labels in sync with configured labels, provided that no other user or bot has made changes to the labels after PR creation. If labels are changed by any other account, Renovate will stop making further changes.
...
This option is available for Azure, Gitea, Forgejo, GitHub and GitLab.
