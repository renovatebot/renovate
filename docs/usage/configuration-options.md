...
The `config:base` preset that many extend from limits the amount of concurrent branches to 10, but in most cases we would recommend lower values such as 5 or 3.
