...
Currently this setting supports `helmv3`, `helm-requirements`, `npm` and `sbt` only, so raise a feature request if you have a use for it with other package managers.
