...
`matchQl` is an experimental query language which be used to create both simple and complex matching logic for `packageRules`.

It can be used to create matching on fields not supported by other `matchX` fields (e.g. `"matchQl": "groupName = 'foo'"`) or also as an alternative for existing fields.
...
| ----------------------------------- | ----------------------------------------- |
| `"matchBaseBranches": ["dev"]`      | `"matchQl": "baseBranch = 'dev'`          |
| `"matchCategories": ["docker"]`     | `"matchQl": "categories = 'docker'`       |
| `"matchCurrentVersion": ">= 1.0.0"` | `"matchQl": "currentVersion = '> 1.0.0'"` |
| `"matchCurrentAge": "> 2 years"`    | `"matchQl": "currentVersionAge > 730"`    |
