...
A template describing the working directory in which the commands should be executed. If the template evaluates to a falsey value then the command will be executed from the root of the repository.
Example:
