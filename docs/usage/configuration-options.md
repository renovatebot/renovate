...
Note: on Azure there can be a delay between a PR being set as completed by RenovateBot, and Azure merging the PR / finishing it's tasks. RenovateBot will try to delay until Azure is in the expected state.
