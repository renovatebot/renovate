...
You can set `useBaseBranchConfig` to 'merge' to instruct Renovate to merge the config from each base branch over the top of the config in the default branch.
