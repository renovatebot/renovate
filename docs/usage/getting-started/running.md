...
If someone else is hosting Renovate for you, or you are using the WhiteSource Renovate App on GitHub, then you can skip ahead to the [installing & onboarding](https://docs.renovatebot.com/getting-started/installing-onboarding/) page.
