...
You can add additional host rules, read the [`hostRules` documentation](../usage/configuration-options.md#hostrules) for more information.
...
1. Add the encoded service account to your configuration file
   ...
   1. If you want to add it to your repository Renovate configuration file, [encrypt](../usage/configuration-options.md#encrypted) it and then add it:
