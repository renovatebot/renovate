...
- If you are using dependencies in a custom way, [there is a special customManager](https://docs.renovatebot.com/configuration-options/#custommanagers) that allows you to transform patterns into dependencies
