...
- `gradle/verification-metadata.xml` signatures and checksums for [dependency verification](https://docs.gradle.org/current/userguide/dependency_verification.html)
