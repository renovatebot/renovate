...
- Catalogs outside the `gradle` folder whose names do not end in `.versions.toml` (unless overridden via [`fileMatch`](../usage/configuration-options.md#filematch) configuration)
