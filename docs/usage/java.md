...
- Catalogs outside the `gradle` folder whose names do not end in `.versions.toml` (unless overridden via [`filePatterns`](./configuration-options.md#filepatterns) configuration)
